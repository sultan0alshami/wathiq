        ...
        <div className={`flex items-center ${isMobile ? 'w-full justify-between order-1' : 'space-x-4 space-x-reverse'}`}>
          ...
          */}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className={`max-h-96 overflow-auto border border-border/70 shadow-lg bg-card/90 backdrop-blur-md supports-[backdrop-filter]:bg-card/70 supports-[backdrop-filter]:backdrop-blur-md z-[9999] ${isMobile ? 'w-screen max-w-sm mx-4 fixed top-20 right-4' : 'w-80'}`}
            >
